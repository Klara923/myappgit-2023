  ...
  (error) => {
    if (error) {
      ...
      const projects = [
        ...
        {
          pId: "5",
          pURL: "img/pixel-cat-3d.jpg",
          pURL1: "img/pixel-cat-3d.jpg",
          pURL2: "img/pixel-cat-3d.mp4",
          pName: "3D Model",
          pOverlayName: "3D Model",
          pAuthor: "Klara S",
          pDate: "15.01.2024",
          pDesc:
            "This 3D object is my first experience with 3D design. Executed using the Spline program, it features a composition comprising my logo, a sleek laptop, and small elements like cubes. Noteworthy is its interactive element – as users navigate their cursor across the screen, the object responds dynamically, adding an engaging layer to the overall experience.",
          ...
          pType: "3D object",
          pProgress:
            "Currently, I am working on a website project whose User Interface will be modern and 'trendy'. Animations and 3D objects are elements that can enhance both the visual appeal and user experience. More and more well-designed websites incorporate those features. Inspired by them, I started to create my graphics while learning the basics of the Spline program and gaining experience in creating 3D objects. My object is composed of the cat from my logo that was created by me. The remaining components such as the laptop were sourced from the Spline library. These elements underwent customization involving alterations in colors, dimensions, and the incorporation of textures such as glow and glass effect. The culminating step involved orchestrating these modified elements into a composition. Additionally, I added a feature allowing users to manipulate the object's position through cursor movements.",
          pLearned:
            "While the project is not complex, its completion requires a dedicated investment of time. I had to learn the basics of the Spline program affording me a foundational understanding of the intricacies involved in the creation and manipulation of 3D objects.",
          pLink1Text: "Splne 3D Object",
          pLink1:
            "https://my.spline.design/macbookprocopy-35f4a29f206f806b43cb9524e518ec5e/",
          pLink2Text: "",
          pLink2: "",
          pPreviousPageBoolean: "1",
          pPreviousPageURL: "4",
